...
for names in UNIVARIATE_DATASET_NAMES:

    print(names)
    filee_path1 = '/home/anand7s/Documents/tsc_transferhpo/Results/SMBO/' + names + '/Running_' + names + '.json'
    # filee_path2 = '/home/anand7s/Documents/transfer_hpo/bigdata18-master/configs_folder/RS_run_' + names + '.json'
